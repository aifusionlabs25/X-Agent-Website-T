...
assert.match(sentPayloads[0].text, /\n\nBest regards,\nDani/);
assert.match(sentPayloads[0].html, /Thanks for speaking with Dani\./);
assert.match(sentPayloads[0].html, /Discussion Summary/);
assert.match(sentPayloads[0].html, /Scheduling \/ Confirmation/);
assert.match(sentPayloads[0].html, /dani-tavus-custom-replica\.png/);
assert.match(sentPayloads[0].html, /Choose your time/);
...
assert.match(sentPayloads[1].html, /New Dani Intake/);
assert.match(sentPayloads[1].html, /Operator action required/);
assert.match(sentPayloads[1].html, /dani-tavus-custom-replica\.png/);
assert.match(sentPayloads[1].html, /Scheduling \/ Follow-up/);
assert.match(sentPayloads[1].html, /Review Intake Details/);
...
assert.match(sentPayloads[2].html, /Dani Lead Intelligence Report/);
assert.match(sentPayloads[2].html, /Prospect Score/);
assert.match(sentPayloads[2].html, /dani-tavus-custom-replica\.png/);
assert.match(sentPayloads[2].html, /Opportunity Signals/);
assert.match(sentPayloads[2].html, /Open Opportunity Brief/);
