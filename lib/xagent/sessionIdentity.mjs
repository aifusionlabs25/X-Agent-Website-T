...
export const HAL_AGENT_SLUG = "hal";
...
export function createDaniSessionIdentity() {
  return createXAgentSessionIdentity({ agentSlug: DANI_AGENT_SLUG });
}

export function createXAgentSessionIdentity({ agentSlug = DANI_AGENT_SLUG } = {}) {
  return {
...
export function buildDaniConversationStartResponse(tavusConversation, startedAt, identity = createDaniSessionIdentity()) {
  return buildXAgentConversationStartResponse(tavusConversation, startedAt, identity);
}

export function buildXAgentConversationStartResponse(tavusConversation, startedAt, identity = createDaniSessionIdentity()) {
  return {
    ...tavusConversation,
