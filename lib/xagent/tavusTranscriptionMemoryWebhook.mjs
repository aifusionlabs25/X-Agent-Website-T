...
export async function handleTavusTranscriptionMemoryWebhook(payload, options = {}) {
  ...
  if (agentSlug === HAL_AGENT_SLUG) {
    return {
      ...
      hermes_email_actions_status: "skipped_for_hal_public_demo",
      hermes_email_action_count: 0,
      agentmail_called: false,
      live_agentmail_called: false,
      agentmail_post_session_send_attempted: false,
      agentmail_post_session_send_status: "skipped_for_hal_public_demo",
      ...
      live_hermes_called: Boolean(storeResult.live_hermes_called),
