...
function renderSafePromptContext(memoryContext) {
  ...
  return [
    "Internal continuity context for Dani: returning-user memory is available.",
    "",
    ...
    "- If the visitor asks what you remember, summarize the prior notes in plain language.",
    "- Dani may naturally continue from prior goals and preferences without sounding uncertain.",
